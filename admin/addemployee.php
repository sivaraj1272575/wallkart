...
select
{
    ...
    <table style="width :100%; height: 40px;" border = 0 cellspacing = 0 >
        ...
        <form id='regForm' method="POST" action="./addemployee1.php" style="margin-left: 50px; margin-right: 50px;">
        <center><h1 style="color: black">Employee Details</h1></center><br>
        <input type="text" name="id" placeholder="Emp Id" required style="float: left">
        <input type="text" name="name" placeholder="Emp Name" required style="float: right"> <br><br><br>
        <input type="text" name="phone" placeholder="Mobile No"  required style="float: left">
        ...
        <select name="district" >
            ...
            <?php
                ...
                {
                    echo '
                    <option value = "'.$row['dist_name'].'">
                    '.$row['dist_name'].'</option>
                    ';
                }
            
            ?>
        </select><br><br><br>
        <input type="submit" value="Add" name="add" ><br><br><br>
        </form>
        <center style="color: black">Click <a style="color: #0D4F8B"href = './changeemployee.php'>here</a> to change the Employee</center>
    </body>
</html>